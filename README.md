...
- Mobile quick navigation, repeated-item search flow, and one-tap cart checkout for rush-hour dispensing.
...
- Printable branded transaction receipts available after checkout and from sales history, with 58 mm, 80 mm, and A4 layouts.
...
- In-app pilot feedback for bugs, confusing or slow workflows, and suggestions, with an Admin triage queue and reporter-visible responses.
