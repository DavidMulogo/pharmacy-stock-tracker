...
const activityActions: ActivityLogAction[] = ["LOGIN", "LOGOUT", "SALE_CREATED", "STOCK_ADDED", "PRODUCTS_IMPORTED", "STOCK_IMPORTED", "EXPENSE_CREATED", "SETTINGS_UPDATED", "STAFF_CREATED", "STAFF_UPDATED", "STAFF_DEACTIVATED", "STAFF_REACTIVATED", "STAFF_PASSWORD_RESET", "REPORT_EXPORTED", "BACKUP_EXPORTED", "BACKUP_VALIDATED"];
